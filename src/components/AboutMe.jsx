...
import got from "../assets/gameofthrones.png"
...
const AboutMe = () => {
  return (
    <div className="relative flex flex-col-reverse lg:flex-row items-center justify-between min-h-screen pr-6 pl-6 pt-3 bg-[#f8f0ee]">
      ...
      <div className="hidden lg:flex flex-col items-center absolute top-10 left-[20%] animate-bounce z-10">
      ...
      <div className="flex-1 flex items-center justify-center mb-8 lg:mb-0 px-4">
        <img
          src={got}
          alt="Game of Thrones"
          className="w-full sm:w-3/4 md:w-1/2 lg:w-auto max-h-[80vh] h-auto object-contain"
        />
      </div>
